...
public static class UmbralNodes
{
    ...
    public static GatheringType GetGatheringType(CloudedNodeType nodeType)
    {
        ...
        {
            CloudedNodeType.CloudedRockyOutcrop   => GatheringType.采矿工,
            CloudedNodeType.CloudedMineralDeposit => GatheringType.采矿工,
            CloudedNodeType.CloudedMatureTree     => GatheringType.园艺工,
            CloudedNodeType.CloudedLushVegetation => GatheringType.园艺工,
